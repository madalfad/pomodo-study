      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            ...
            <a href="https://www.buymeacoffee.com/madalfad">
              <img src="https://img.buymeacoffee.com/button-api/?text=Buy me a coffee&emoji=&slug=madalfad&button_colour=FFDD00&font_colour=000000&font_family=Cookie&outline_colour=000000&coffee_colour=ffffff" />
            </a>
          </div>
        </div>

        <div className="mt-6 border-t border-gray-800 pt-4 text-center text-xs text-gray-500 font-workSans">
          <p>&copy; {currentYear} <a href="https://linktr.ee/madalfad">Mahmoud Al-Fadhl</a>. All rights reserved.</p>
          <p className="mt-1">
